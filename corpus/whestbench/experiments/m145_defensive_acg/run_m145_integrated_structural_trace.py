"""Fresh-process target-shaped structural trace for integrated M145.
...
def main() -> None:
    ...
    reference = raw_qr_radius_bank_numpy(SETUP_SEED)
    ...
    if args.kind == "candidate":
        ...
        reference2 = raw_qr_radius_bank_numpy(SETUP_SEED)
    ...
    result = {
        "status": "INTEGRATED_STRUCTURAL_TRACE_ONLY_NO_EFFICACY",
        "kind": args.kind,
        "firewall": (
        ...
        "seeds": {
            "setup": SETUP_SEED,
            "structural_mlp": STRUCTURAL_MLP_SEED,
        },
        "setup_s": setup_s,
