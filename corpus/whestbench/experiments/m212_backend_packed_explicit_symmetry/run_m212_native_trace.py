"""Fresh-process generated-only native trace for frozen M212."""
...
from m212_flopscope_sidecar import (  # noqa: E402
    LayerInput,
...
def run_trace(records: list[LayerInput]) -> dict[str, object]:
    ...
    return {
        ...
        "prediction_match": {
            ...
            "matmul_bill": int(matmul.get("flop_cost", -1)) == 1_167_925_248,
            "reshape_calls": int(reshape.get("calls", -1)) == 4,
            "reshape_bill": int(reshape.get("flop_cost", -1)) == 16_252_928,
...
def main() -> None:
    ...
    payload = {
        "status": "M212_GENERATED_BACKEND_PACKED_RESOURCE_TRACE_ONLY",
